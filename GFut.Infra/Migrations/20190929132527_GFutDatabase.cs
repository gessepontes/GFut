    ...
    public partial class GFutDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerAssistance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerAssistance_MatchPlayer_MatchPlayerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlayerPoints_MatchPlayer_MatchPlayerId",
                        column: x => x.MatchPlayerId,
                        principalTable: "MatchPlayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerAssistance_MatchPlayerId",
                table: "PlayerAssistance",
                column: "MatchPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerPoints_MatchPlayerId",
                table: "PlayerPoints",
                column: "MatchPlayerId");
