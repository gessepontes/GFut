...
import { saveMatchSummaryRequest
...
const MatchSummaryDetails = props => {
  ...
  function handleSubmit(data) {
    data.id = matchSummary.id;
    data.active = matchSummary.active; 
    data.registerDate = matchSummary.registerDate; 
    dispatch(saveMatchSummaryRequest(data));
  }

  const championship = useSelector(state => state.championship.championship);
  const matchSummary = useSelector(state => state.matchSummary.matchSummary);
  ...
  return (
    ...
    >
      <Form initialData={matchSummary} onSubmit={handleSubmit}>
        <CardHeader
...
MatchSummaryDetails.propTypes = {
  className: PropTypes.string
};

export default MatchSummaryDetails;
